(function (global, factory) {
  ...
  function ydLine(isMobile, state, sel, key, question, globals, data, indexedTimepoint, indexedData) {
    ...
    c.grid.append("g").attr("class", "horizontal").call(d3.axisBottom(c.x).tickValues(c.x.ticks(maxYear - minYear)).tickFormat("").tickSize(c.height)).selectAll("line").attr("class", function (d) {
